...
class ExchangePlace extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangePlace', package: const $pb.PackageName(_omitMessageNames ? '' : 'blueOceanField.market'), createEmptyInstance: create)
...
class ExchangePlaces extends $pb.GeneratedMessage {
  factory ExchangePlaces({
    $core.Iterable<ExchangePlace>? exchangePlaces,
  }) {
    final $result = create();
    if (exchangePlaces != null) {
      $result.exchangePlaces.addAll(exchangePlaces);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangePlaces', package: const $pb.PackageName(_omitMessageNames ? '' : 'blueOceanField.market'), createEmptyInstance: create)
    ..pc<ExchangePlace>(1, _omitFieldNames ? '' : 'exchangePlaces', $pb.PbFieldType.PM, protoName: 'exchangePlaces', subBuilder: ExchangePlace.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<ExchangePlace> get exchangePlaces => $_getList(0);
}
...
class Symbol extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Symbol', package: const $pb.PackageName(_omitMessageNames ? '' : 'blueOceanField.market'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'code')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOM<ExchangePlace>(3, _omitFieldNames ? '' : 'exchange', subBuilder: ExchangePlace.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  ExchangePlace get exchange => $_getN(2);
  @$pb.TagNumber(3)
  set exchange(ExchangePlace v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasExchange() => $_has(2);
  @$pb.TagNumber(3)
  void clearExchange() => clearField(3);
  @$pb.TagNumber(3)
  ExchangePlace ensureExchange() => $_ensure(2);
}
...
class Symbols extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Symbols', package: const $pb.PackageName(_omitMessageNames ? '' : 'blueOceanField.market'), createEmptyInstance: create)
