...
import '../descriptor.pb.dart' as $6;
...
class CodeGeneratorRequest extends $pb.GeneratedMessage {
  factory CodeGeneratorRequest({
    ...
    $core.Iterable<$6.FileDescriptorProto>? protoFile,
    $core.Iterable<$6.FileDescriptorProto>? sourceFileDescriptors,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CodeGeneratorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf.compiler'), createEmptyInstance: create)
    ...
    ..pc<$6.FileDescriptorProto>(15, _omitFieldNames ? '' : 'protoFile', $pb.PbFieldType.PM, subBuilder: $6.FileDescriptorProto.create)
    ..pc<$6.FileDescriptorProto>(17, _omitFieldNames ? '' : 'sourceFileDescriptors', $pb.PbFieldType.PM, subBuilder: $6.FileDescriptorProto.create)
  ;
  ...
  ///  fully qualified.
  @$pb.TagNumber(15)
  $core.List<$6.FileDescriptorProto> get protoFile => $_getList(3);

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  @$pb.TagNumber(17)
  $core.List<$6.FileDescriptorProto> get sourceFileDescriptors => $_getList(4);
}
...
class CodeGeneratorResponse_File extends $pb.GeneratedMessage {
  factory CodeGeneratorResponse_File({
    ...
    $core.String? content,
    $6.GeneratedCodeInfo? generatedCodeInfo,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CodeGeneratorResponse.File', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf.compiler'), createEmptyInstance: create)
    ...
    ..aOM<$6.GeneratedCodeInfo>(16, _omitFieldNames ? '' : 'generatedCodeInfo', subBuilder: $6.GeneratedCodeInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $6.GeneratedCodeInfo get generatedCodeInfo => $_getN(3);
  @$pb.TagNumber(16)
  set generatedCodeInfo($6.GeneratedCodeInfo v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasGeneratedCodeInfo() => $_has(3);
  @$pb.TagNumber(16)
  void clearGeneratedCodeInfo() => clearField(16);
  @$pb.TagNumber(16)
  $6.GeneratedCodeInfo ensureGeneratedCodeInfo() => $_ensure(3);
}
